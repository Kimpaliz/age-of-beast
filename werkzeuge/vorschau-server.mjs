...
const FREIGEGEBENE_DATEIEN = new Set([
  ...
  'karte/figuren-eigen.js',
  'karte/erschaffung.js',
  'karte/erschaffung-schritte.js',
  'werkzeuge/erschaffung-regeln.mjs',
  'daten/daggerheart-klassen.json',
  'erschaffung.html',
